...
import { ProfileInfoVisitorModel } from '../../model';

type ProfileInfoVisitorProps = {
  $$model: ProfileInfoVisitorModel;
};

export function ProfileInfoVisitor(props: ProfileInfoVisitorProps) {
  const { $$model } = props;
